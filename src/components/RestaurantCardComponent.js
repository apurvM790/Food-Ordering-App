...
export const RestaurantCardComponent = (props)=>{
    ...
    return (
        <div className="mx-6 h-[430px] my-6 px-3 py-3 rounded-3xl bg-slate-300 w-[240px] transition-all hover:shadow-lg slate-500">
            <div>
            <img className=" size-[220px] border-2 my-1 rounded-xl shadow-md to-slate-400 transition-all hover:scale-95" alt="res-logo" 
            src={
